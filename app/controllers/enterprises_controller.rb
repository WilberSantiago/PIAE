class EnterprisesController < ApplicationController
  ...
  def index
    @enterprises = Enterprise.take(18)
  ...
  private
    ...
    def enterprise_params
      params.require(:enterprise).permit(:title, :email, :municipality_id, :entry_id, :owner, :about, :phone, :image, :address, :latitude, :longitude)
    end
end
