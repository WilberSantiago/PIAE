...
class WelcomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create welcome" do
    assert_difference('Welcome.count') do
      post welcomes_url, params: { welcome: { about: @welcome.about, address: @welcome.address, email: @welcome.email, latitude: @welcome.latitude, longitude: @welcome.longitude, phone: @welcome.phone, subtitle: @welcome.subtitle, title: @welcome.title } }
    end
  ...
  test "should update welcome" do
    patch welcome_url(@welcome), params: { welcome: { about: @welcome.about, address: @welcome.address, email: @welcome.email, latitude: @welcome.latitude, longitude: @welcome.longitude, phone: @welcome.phone, subtitle: @welcome.subtitle, title: @welcome.title } }
