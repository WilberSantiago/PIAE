...
class EnterprisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enterprise" do
    assert_difference('Enterprise.count') do
      post enterprises_url, params: { enterprise: { about: @enterprise.about, address: @enterprise.address, email: @enterprise.email, entry_id: @enterprise.entry_id, image: @enterprise.image, latitude: @enterprise.latitude, longitude: @enterprise.longitude, municipality_id: @enterprise.municipality_id, owner: @enterprise.owner, phone: @enterprise.phone, title: @enterprise.title } }
    end
  ...
  test "should update enterprise" do
    patch enterprise_url(@enterprise), params: { enterprise: { about: @enterprise.about, address: @enterprise.address, email: @enterprise.email, entry_id: @enterprise.entry_id, image: @enterprise.image, latitude: @enterprise.latitude, longitude: @enterprise.longitude, municipality_id: @enterprise.municipality_id, owner: @enterprise.owner, phone: @enterprise.phone, title: @enterprise.title } }
